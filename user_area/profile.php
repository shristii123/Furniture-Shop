...
<body>
  ...
  <div class="other-links">
    ...
    ?>
    <button class="btn-signup" id="forms"><a href="profile.php">My account</a></button>
...
<div class="row">
    <div class="col-md-2">
        ...
        <li class="nav-item" style="background-color: #FFA756;">
                  <a class="nav-link text-black"  href="#"><h4>Your Profile</a>
        </li>
        <?php
        $username=$_SESSION['username'];
        $user_image="Select * from `usertable` where username='$username'";
        ...
        <li class="nav-item" style="background-color: #FFA756;">
                  <a class="nav-link text-black"  href="profile.php">Pending Orders</a>
        </li>
        <li class="nav-item" style="background-color: #FFA756;">
                  <a class="nav-link text-black"  href="profile.php?edit_account">Edit Account</a>
        </li>
        <li class="nav-item" style="background-color: #FFA756;">
                  <a class="nav-link text-black"  href="profile.php?my_orders">My Order</a>
        </li>
        <li class="nav-item" style="background-color: #FFA756;">
